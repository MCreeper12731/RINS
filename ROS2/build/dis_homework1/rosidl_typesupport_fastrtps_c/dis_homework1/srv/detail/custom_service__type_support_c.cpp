...
#include "dis_homework1/srv/detail/custom_service__rosidl_typesupport_fastrtps_c.h"
...
using _CustomService_Request__ros_msg_type = dis_homework1__srv__CustomService_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = 10;
    auto array_ptr = ros_message->field2;
...
size_t get_serialized_size_dis_homework1__srv__CustomService_Request(
  const void * untyped_ros_message,
...
static uint32_t _CustomService_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dis_homework1__srv__CustomService_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dis_homework1
size_t max_serialized_size_dis_homework1__srv__CustomService_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dis_homework1__srv__CustomService_Request;
    is_plain =
      (
      offsetof(DataType, field2) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _CustomService_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dis_homework1__srv__CustomService_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dis_homework1, srv, CustomService_Request)() {
...
// already included above
// #include "rosidl_runtime_c/string.h"  // field3
// already included above
// #include "rosidl_runtime_c/string_functions.h"  // field3

// forward declare type support functions


using _CustomService_Response__ros_msg_type = dis_homework1__srv__CustomService_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: field3
  {
    const rosidl_runtime_c__String * str = &ros_message->field3;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: field3
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->field3.data) {
      rosidl_runtime_c__String__init(&ros_message->field3);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->field3,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'field3'\n");
      return false;
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dis_homework1
size_t get_serialized_size_dis_homework1__srv__CustomService_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CustomService_Response__ros_msg_type * ros_message = static_cast<const _CustomService_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += padding +
    eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
    (ros_message->field3.size + 1);
  // field.name field4
  {
    size_t item_size = sizeof(ros_message->field4);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_dis_homework1__srv__CustomService_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dis_homework1
size_t max_serialized_size_dis_homework1__srv__CustomService_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dis_homework1__srv__CustomService_Response;
    is_plain =
      (
      offsetof(DataType, field4) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _CustomService_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dis_homework1__srv__CustomService_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dis_homework1, srv, CustomService_Response)() {
...
// already included above
// #include "dis_homework1/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "dis_homework1/srv/custom_service.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dis_homework1, srv, CustomService)() {
